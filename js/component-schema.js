export const categoryFormConfig = {
  ...
  gpu: {
    ...
    fields: [
      ...
      { key: 'boostClock', label: 'Boost частота GPU (МГц)', type: 'number', step: '1', min: '0', required: true, placeholder: '2475' },
  ...
  motherboard: {
    ...
    fields: [
      ...
      { key: 'memoryType', label: 'Тип RAM', control: 'select', options: ['DDR4', 'DDR5'] },
      { key: 'memorySlots', label: 'Слоты RAM', type: 'number', step: '1', min: '1', placeholder: '4' },
      { key: 'maxMemory', label: 'Макс. объём RAM (ГБ)', type: 'number', step: '1', min: '1', placeholder: '192' },
  ...
  power_supply: {
    ...
    fields: [
      ...
      { key: 'modular', label: 'Модульность', control: 'select', options: ['Full', 'Semi', 'No'] },
  ...
  case: {
    ...
    fields: [
      ...
      { key: 'color', label: 'Цвет', placeholder: 'Black / White' },
      { key: 'maxGpuLength', label: 'Макс. длина GPU (мм)', type: 'number', step: '1', min: '0', placeholder: '400' },
